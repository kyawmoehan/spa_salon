...
<div class="main-content-inner">
    <form method="GET" action="{{route('purchase.index')}}">
            ...
            <div class="row align-self-end">
                <div class="col-12">
                    <div class="input-group">
                        ...
                        @if($searched)
                            <a href="{{route('purchase.index')}}" class="btn btn-outline-info">Clear Search</a>
                        @endif
                    </div>
                </div>
            </div>
        ...
        <table class="table table-hover progress-table text-center" id="myTable1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$purchaseItem->item->type->name}}</td>
                    <td>{{$purchaseItem->purchase_price}} Ks</td>
        ...
        {{ $purchaseItems->appends(Request::except('page'))->links("pagination::bootstrap-5") }}
        <div class="mt-3">
